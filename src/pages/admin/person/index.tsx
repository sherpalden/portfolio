        ...
        <Wrapper>
            <form className="form-wrapper" onSubmit={onSubmit}>
                ...
                <div>
                    <Label>Social Medias
                        <PlusCircleFilled
                            onClick={() => { appendSocialMedia({ name: "", link: "" }) }}
                            style={{
                                fontSize: "24px",
                                color: theme.line
                            }}
                ...
                <div>
                    <Label>Skills
                        <PlusCircleFilled
                            onClick={() => { appendSkill({ name: "", level: "", experiencePeriod: "" }) }}
                            style={{
                                fontSize: "24px",
                                color: theme.line
                            }}
                ...
                <div>
                    <Label>Educations
                        <PlusCircleFilled
                            onClick={() => { appendEducation({ level: "", institute: "", fromDate: "", toDate: "", website: "" }) }}
                            style={{
                                fontSize: "24px",
                                color: theme.line
                            }}
                ...
                <div>
                    <Label>Work Experiences
                        <PlusCircleFilled
                            onClick={() => { appendWork({ position: "", company: "", fromDate: "", toDate: "", website: "" }) }}
                            style={{
                                fontSize: "24px",
                                color: theme.line
                            }}
